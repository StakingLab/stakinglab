...
#   c) node1 mines 32 blocks, so now node 0 has 500000LABX, node 1 has 4250LABX, node2 has none.
#   d) node0 sends 601 LABX to node2, in two transactions (301 LABX, then 300 LABX).
