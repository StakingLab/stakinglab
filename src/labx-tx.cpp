...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Stakinglab Coin labx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  labx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stakinglab transaction") + "\n" +
                               "  labx-tx [options] -create [commands]   " + _("Create hex-encoded stakinglab transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stakinglab transaction
