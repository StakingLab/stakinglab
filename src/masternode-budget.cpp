...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
    ...
    if (nHeight > 0 && nHeight <= 9999) nSubsidy = 0.01 * COIN;
    else if (nHeight >= 10000 && nHeight <= 19999) nSubsidy = 0.2 * COIN;
    else if (nHeight >= 20000 && nHeight <= 29999) nSubsidy = 0.3 * COIN;
    else if (nHeight >= 30000 && nHeight <= 39999) nSubsidy = 0.4 * COIN;
    else if (nHeight >= 40000 && nHeight <= 49999) nSubsidy = 0.8 * COIN;
    else if (nHeight >= 50000 && nHeight <= 64999) nSubsidy = 0.6 * COIN;
    else if (nHeight >= 65000 && nHeight <= 79999) nSubsidy = 0.7 * COIN;
    else if (nHeight >= 80000 && nHeight <= 94999) nSubsidy = 0.8 * COIN;
    else if (nHeight >= 95000 && nHeight <= 104999) nSubsidy = 1.6 * COIN;
    else if (nHeight >= 105000 && nHeight <= 119999) nSubsidy = 1.8 * COIN;
    else if (nHeight >= 120000 && nHeight <= 149999) nSubsidy = 1.6 * COIN;
    else if (nHeight >= 150000 && nHeight <= 189999) nSubsidy = 1.2 * COIN;
