...
// LABX: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_15_MINSTAKE_ENFORCEMENT) r = SPORK_15_MINSTAKE_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_16_BLACKLIST_ADDRS_ENFORCEMENT) r = SPORK_16_BLACKLIST_ADDRS_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_MINSTAKE_ENFORCEMENT") return SPORK_15_MINSTAKE_ENFORCEMENT;
    if (strName == "SPORK_16_BLACKLIST_ADDRS_ENFORCEMENT") return SPORK_16_BLACKLIST_ADDRS_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_15_MINSTAKE_ENFORCEMENT) return "SPORK_15_MINSTAKE_ENFORCEMENT";
    if (id == SPORK_16_BLACKLIST_ADDRS_ENFORCEMENT) return "SPORK_16_BLACKLIST_ADDRS_ENFORCEMENT";
