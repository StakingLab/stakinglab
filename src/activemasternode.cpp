...
//
// Bootup the Masternode, look for a LABX collateral input and register on the network
//
...
vector<COutput> CActiveMasternode::SelectCoinsMasternode()
{
    ...
    for (const COutput& out : vCoins) {
        if (out.tx->vout[out.i].nValue == GetMasternodeCollateral(chainActive.Height()) * COIN)
