...
/** Utility functions used by the Stakinglab Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render LABX addresses in monospace font
...
// Parse "stakinglab:" URI into recipient object, return true on successful parsing
