                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Stakinglab Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LABX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stakinglab: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Stakinglab Coin"), this);
    aboutAction->setStatusTip(tr("Show information about Stakinglab Coin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Stakinglab Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LABX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LABX addresses"));
    ...
    openAction->setStatusTip(tr("Open a stakinglab: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Stakinglab Coin help message to get a list with possible Stakinglab Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/labx_logo_horizontal").pixmap(175, 52));
    ...
    if (enableWallet) {
        ...
        frameToolbar->setStyleSheet(".QFrame { margin-left:-0px; background-color: #112649; }");
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Stakinglab Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stakinglab Coin network", "", count));
}
...
{
    QString strTitle = tr("Stakinglab Coin"); // default title
    ...
    // Append title to "Stakinglab Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
