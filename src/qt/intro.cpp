...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Stakinglab Coin"),
     ...
     * override -datadir in the stakinglab.conf file in the default data directory
     * (to be consistent with labxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
