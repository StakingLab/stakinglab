...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Stakinglab Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Stakinglab Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Stakinglab Coin features */
        {"stakinglab", "masternode", &masternode, true, true, false},
        {"stakinglab", "listmasternodes", &listmasternodes, true, true, false},
        {"stakinglab", "getmasternodecount", &getmasternodecount, true, true, false},
        {"stakinglab", "masternodeconnect", &masternodeconnect, true, true, false},
        {"stakinglab", "masternodecurrent", &masternodecurrent, true, true, false},
        {"stakinglab", "masternodedebug", &masternodedebug, true, true, false},
        {"stakinglab", "startmasternode", &startmasternode, true, true, false},
        {"stakinglab", "createmasternodekey", &createmasternodekey, true, true, false},
        {"stakinglab", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"stakinglab", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"stakinglab", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"stakinglab", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"stakinglab", "getmasternodescores", &getmasternodescores, true, true, false},
        {"stakinglab", "mnbudget", &mnbudget, true, true, false},
        {"stakinglab", "preparebudget", &preparebudget, true, true, false},
        {"stakinglab", "submitbudget", &submitbudget, true, true, false},
        {"stakinglab", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"stakinglab", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"stakinglab", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"stakinglab", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"stakinglab", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"stakinglab", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"stakinglab", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stakinglab", "checkbudgets", &checkbudgets, true, true, false},
        {"stakinglab", "mnsync", &mnsync, true, true, false},
        {"stakinglab", "spork", &spork, true, true, false},
        {"stakinglab", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"stakinglab", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"stakinglab", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"stakinglab", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"stakinglab", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"stakinglab", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> labx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:53384/\n";
}
