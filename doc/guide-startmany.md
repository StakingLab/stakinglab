...
2. [Sending 2,000 Stakinglab Coin to new wallet addresses.](#option2)
...
### Send 2,000 LABX to New Addresses

Just like setting up a standard MN. Send exactly 2,000 LABX to each new address created above.
...
*Please note, the masternode private key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 2,000 LABX on the remote server and defeats the purpose of a hot/cold setup.*
