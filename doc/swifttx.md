...
This mechanism has been integrated into Bitcore-Node-Stakinglab Coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stakinglab/insight-api-stakinglab#web-socket-api](https://github.com/stakinglab/insight-api-stakinglab#web-socket-api)
* API: [https://github.com/stakinglab/insight-api-stakinglab#swifttx-transactions](https://github.com/stakinglab/insight-api-stakinglab#swifttx-transactions)
...
By default, the Stakinglab Coin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stakinglab Coin daemon:
