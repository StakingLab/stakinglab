...
In order to support loading of multiple wallets in labx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stakinglab.cpp.
...
Changes to stakinglab.cpp
----------------------
stakinglab.cpp is the entry point into labx-qt, and as such, will require some minor modifications to provide hooks for
