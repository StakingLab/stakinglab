...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/stakinglab-config.h \
           src/crypto/common.h \
...
RESOURCES += src/qt/labx.qrc src/qt/labx_locale.qrc

TRANSLATIONS += src/qt/locale/labx_bg.ts \
                src/qt/locale/labx_de.ts \
                src/qt/locale/labx_en.ts \
                src/qt/locale/labx_es.ts \
                src/qt/locale/labx_fi.ts \
                src/qt/locale/labx_fr.ts \
                src/qt/locale/labx_it.ts \
                src/qt/locale/labx_ja.ts \
                src/qt/locale/labx_pl.ts \
                src/qt/locale/labx_pt.ts \
                src/qt/locale/labx_ru.ts \
                src/qt/locale/labx_sk.ts \
                src/qt/locale/labx_sv.ts \
                src/qt/locale/labx_vi.ts \
                src/qt/locale/labx_zh_CN.ts \
                src/qt/locale/labx_zh_TW.ts
