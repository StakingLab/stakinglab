Contributing to Stakinglab Coin
==================================

The Stakinglab Coin project operates an open contributor model where anyone is
...
The following applies to code changes to the Stakinglab Coin project, and is not to be
confused with overall Stakinglab Coin Network Protocol consensus changes.

Whether a pull request is merged into Stakinglab Coin rests with the project merge
...
Patches that change Stakinglab Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Stakinglab Coin consensus, it must have been
...
The project leader is the release manager for each Stakinglab Coin release.
